...
HD_PWD='/home/ICer/ic_prjs/parallel_prefix/work/parallel_prefix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ppa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ppa.tcl
